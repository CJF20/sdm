...
<div id="kanan">
  <div class="top-menu">
    <nav class="left">
      ...
      <a class="active-tab" href="dashboard.php?url=rikkes1">RIKKES I</a>
...
<!-- HIDE 
          ...
          <?php
            ...
            while($casis = mysqli_fetch_array($query)){
              ...
              echo "</td>";
              echo "<td>";
              echo "<button class='buttonn' href='diapers/hapus_data_rikkes1.php?regist_online=".$casis['regist_online']."'> HAPUS </button>";
              echo "</td>";
            }
          ?>
        </tbody>
